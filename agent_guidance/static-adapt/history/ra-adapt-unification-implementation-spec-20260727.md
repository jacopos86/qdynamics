...
Decision authority: `agent_guidance/static-adapt/history/ra-adapt-unification-refactor-decisions-20260727.md` (the "decision record").
...
- This planning step edited only:
  `agent_guidance/static-adapt/history/ra-adapt-unification-implementation-spec-20260727.md`.
