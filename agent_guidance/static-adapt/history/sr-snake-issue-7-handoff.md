...
`agent_guidance/static-adapt/history/paper-i-sr-snake-current-run-map.md`, and
`agent_guidance/static-adapt/history/route-identities.md` before editing. The referenced
