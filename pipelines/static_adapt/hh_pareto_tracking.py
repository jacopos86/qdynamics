...
from pipelines.static_adapt.selector_measurement_proxy import history_controller_measurement_work_stats
...
class HHParetoRow:
    ...
    selector_shot_proxy_source: str | None = None
    selector_shot_proxy_legacy_fallback_used: bool | None = None
    controller_shot_proxy_source: str | None = None
    controller_shot_proxy_legacy_fallback_used: bool | None = None
...
def extract_staged_hh_pareto_rows(
    *,
    ...
    for row in history_rows:
        ...
        measurement_stats = history_controller_measurement_work_stats(rec) or {}
        ...
        groups_new = _to_int(measurement_stats.get("total_groups_new", measurement_stats.get("groups_new"))) or 0
        shots_new = _to_float(measurement_stats.get("total_shots_new", measurement_stats.get("shots_new"))) or 0.0
        ...
        rows.append(
            HHParetoRow(
                **adapt_base,
                ...
                selector_shot_proxy_source=str(measurement_stats.get("controller_proxy_source", measurement_stats.get("source_kind", ""))),
                selector_shot_proxy_legacy_fallback_used=bool(
                    measurement_stats.get("controller_proxy_legacy_fallback_used", False)
                ),
                controller_shot_proxy_source=str(measurement_stats.get("controller_proxy_source", measurement_stats.get("source_kind", ""))),
                controller_shot_proxy_legacy_fallback_used=bool(
                    measurement_stats.get("controller_proxy_legacy_fallback_used", False)
                ),
