...
class PaperIHHDisplayedResultSettings:
    ...
    commutation_reduced_insertion_position_search: bool = True
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            ...
            "commutation_reduced_insertion_position_search": bool(
                self.commutation_reduced_insertion_position_search
            ),
