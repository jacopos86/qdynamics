        ...
        "settings": {
            ...
            **dict(resolved_phase12_energy_model_policies),
            ...
            "phase1_prune_policy": str(
                getattr(args, "phase1_prune_policy", "recoverability_ladder_v1")
            ),
            ...
            "phase1_prune_recovery_trust_radius": float(
                getattr(args, "phase1_prune_recovery_trust_radius", 0.0)
            ),
            ...
            "phase1_prune_metric_schur_mu": float(
                getattr(args, "phase1_prune_metric_schur_mu", 1.0e-6)
            ),
            ...
            "phase1_prune_trust_update_policy": str(
                getattr(args, "phase1_prune_trust_update_policy", "off")
            ),
            "phase1_prune_metric_mu_update_policy": str(
                getattr(args, "phase1_prune_metric_mu_update_policy", "off")
            ),
            "phase1_prune_endpoint_overlap_policy": str(
                getattr(args, "phase1_prune_endpoint_overlap_policy", "off")
            ),
            ...
            "phase1_prune_live_min_depth": int(
                getattr(args, "phase1_prune_live_min_depth", 0)
            ),
