...
3. **Docs Hierarchy**: For execution contracts, refer back to `pipelines/run_guide.md` if any conflicts arise concerning run scaling, but `MATH/Math.md` holds the specific `secant` equations.