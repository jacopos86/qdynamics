...
exec > artifacts/logs/l2_hh_open_fromsnap_phase3_allhhmeta_u4_g05_nph2.log 2>&1
echo $$ > artifacts/runstate/l2_hh_open_fromsnap_phase3_allhhmeta_u4_g05_nph2.pid
python -u pipelines/hardcoded/hh_staged_noiseless.py \
  ...
  --ordering blocked \
  --boundary open \
  --handoff-from-warm-checkpoint artifacts/json/l2_hh_open_teacher4_phase3_allhhmeta_u4_g05_nph2_warm_checkpoint_snapshot_01.json \
  ...
  --ecut-1 1e-2 \
  --ecut-2 1e-4 \
  --tag l2_hh_open_fromsnap_phase3_allhhmeta_u4_g05_nph2 \
  --skip-pdf
code=$?
echo "$code" > artifacts/runstate/l2_hh_open_fromsnap_phase3_allhhmeta_u4_g05_nph2.exit
exit "$code"
