...
\hypertarget{qpu-l2-winner-framing-and-real-qpu-settings-april-11-2026}{%
...
\hypertarget{current-checkout-state-cost-vs-energy}{%
...
\tightlist
\item
  The frozen legacy route still wins the repo-wide cost-vs-energy
  objective at essentially the same energy gate: \texttt{81} 2Q at
  \texttt{\textbar{}\textbackslash{}Delta\ E\textbar{}=5.6178234645e-05}.
\item
  The best current-route comparable replay is still heavier:
  \texttt{168} 2Q at
  \texttt{\textbar{}\textbackslash{}Delta\ E\textbar{}=5.7102691670e-05}.
\item
  The best current fullhorse-style replay is heavier again: \texttt{193}
  2Q at
  \texttt{\textbar{}\textbackslash{}Delta\ E\textbar{}=5.7102730821e-05}.
\item
  The best saved diagnostic native recovery branch remains the
  \texttt{children\_off\ +\ repeats\_off\ +\ hist} line: \texttt{160} 2Q
  at
  \texttt{\textbar{}\textbackslash{}Delta\ E\textbar{}=5.6178241861e-05}.
\item
  A fresh Optuna-guided global-lane search on the same bridge surface
  improves that current-code non-legacy burden to \texttt{151} 2Q at
  \texttt{\textbar{}\textbackslash{}Delta\ E\textbar{}=5.6178252746e-05},
  still heavier than the legacy \texttt{81}-2Q oracle but now the best
  fresh current-code line found in this checkout.
\item
...
408 \\
Best fresh current-code global-search line &
\texttt{20260413\_hh\_l2\_cost\_energy\_optuna\_pilot\_v3/global/eps\_6.200em05/trial\_0014}
& \texttt{bridge\_diag}-based Optuna global lane
(\texttt{proxy\_reduced}, repeats off, motif off, live prune) &
\texttt{5.6178252746e-05} & 13 & 36 & 151 & 408 \\
...
The current state of the repo is therefore not ambiguous: the frozen
legacy path still dominates the cost-vs-energy frontier, while the best
current-route replays remain substantially heavier at the same energy
target.
...
replacing it: the first Optuna global-lane cost-vs-energy pilot pushed
the same bridge family down further to \texttt{151} transpiled two-qubit
gates at
...
with the fresh artifact saved at
\texttt{artifacts/agent\_runs/20260413\_hh\_l2\_cost\_energy\_optuna\_pilot\_v3/global/eps\_6.200em05/trial\_0014/}.
The selected prefix of that fresh line is
