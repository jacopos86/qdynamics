...
\section*{17. Projective McLachlan Real-Time Dynamics and Checkpoint-Adaptive Snake Control}
...
\subsection*{17.1 Fixed-scaffold projective geometry}
...
\subsection*{17.2 Checkpoint miss test and telemetry-driven controller outputs}
...
\subsection*{17.3 Live checkpoint controller: stay, append, and prune}
...
\subsection*{17.4 Append broad screen over candidate-position records}
...
\subsection*{17.5 Append confirm, compressed rerank, and exact commit}
...
\subsection*{17.6 Local scaffold pruning and rollback}
...
\subsection*{17.A Future branch-level rollout and beam extension}
...
% Archived long-form derivation retained below for reference only.
\iffalse
\section*{17. Projective McLachlan Real-Time Geometry and Piecewise Beam-Adaptive Control}
...
\subsection*{17.1 What problem is being solved?}
...
\subsection*{17.2 Why projective Hilbert space is the right setting}
...
\subsection*{17.3 The current manifold and its allowed velocities}
...
\subsection*{17.4 The fixed-structure McLachlan step}
...
\subsection*{17.5 What regularization means}
...
\subsection*{17.6 Why the residual is the right local error quantity}
...
\subsection*{17.7 The geometric projector behind the formulas}
...
\subsection*{17.8 What a candidate generator really is}
...
\subsection*{17.9 The exact local gain formula}
...
\subsection*{17.10 What $S$ and $w$ mean}
...
\subsection*{17.11 The unregularized geometric meaning}
...
\subsection*{17.12 When should the ansatz adapt?}
...
\subsection*{17.13 Which candidates should be admissible?}
...
\subsection*{17.14 Two different residuals should be tracked}
...
\subsection*{17.15 Why integrated residual is the right branch-pruning quantity}
...
\subsection*{17.16 The branch objective}
...
\subsection*{17.17 The full process, in one coherent sequence}
...
\subsection*{17.18 One concise interpretation}
...
\subsection*{17.19 Explicit symbolic--mathematical differences between the clean story and the current implementation}
