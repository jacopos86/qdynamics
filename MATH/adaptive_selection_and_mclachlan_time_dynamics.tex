...
\subsubsection*{11.2.1 Core signal, append position, and one-coordinate local model}
...
\section*{17A. Projective McLachlan Real-Time Dynamics and Checkpoint-Adaptive Snake Control}
...
\subsection*{17A.1 Fixed-scaffold projective geometry}
...
\subsection*{17A.2 Checkpoint miss test and telemetry-driven controller outputs}
...
\subsection*{17A.3 Live checkpoint controller: stay, append, and prune}
...
\subsection*{17A.4 Append broad screen over candidate-position records}
...
\subsection*{17A.5 Append confirm, compressed rerank, and exact commit}
...
\subsection*{17A.6 Local scaffold pruning and rollback}
...
\subsection*{17A.7 Future branch-level rollout and beam extension}
...
% Archived long-form derivation retained below for reference only, now surfaced in the compiled manuscript.
\newpage
\section*{17B. Projective McLachlan Real-Time Geometry and Piecewise Beam-Adaptive Control}
...
\subsection*{17B.1 What problem is being solved?}
...
\subsection*{17B.2 Why projective Hilbert space is the right setting}
...
\subsection*{17B.3 The current manifold and its allowed velocities}
...
\subsection*{17B.4 The fixed-structure McLachlan step}
...
\subsection*{17B.5 What regularization means}
...
\subsection*{17B.6 Why the residual is the right local error quantity}
...
\subsection*{17B.7 The geometric projector behind the formulas}
...
\subsection*{17B.8 What a candidate generator really is}
...
\subsection*{17B.9 The exact local gain formula}
...
\subsection*{17B.10 What $S$ and $w$ mean}
...
\subsection*{17B.11 The unregularized geometric meaning}
...
\subsection*{17B.12 When should the ansatz adapt?}
...
\subsection*{17B.13 Which candidates should be admissible?}
...
\subsection*{17B.14 Two different residuals should be tracked}
...
\subsection*{17B.15 Why integrated residual is the right branch-pruning quantity}
...
\subsection*{17B.16 The branch objective}
...
\subsection*{17B.17 The full process, in one coherent sequence}
...
\subsection*{17B.18 One concise interpretation}
...
\subsection*{17B.19 Explicit symbolic--mathematical differences between the clean story and the current implementation}
...
\subsection*{17B.20 Discrete spectra and density-sector observables for HH checkpoint dynamics}
