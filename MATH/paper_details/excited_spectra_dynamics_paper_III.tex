...
\end{itemize}
The ranked quantity is this utility discounted by the record's incremental compiled hardware cost and penalized for conditioning,
\begin{equation}
\Scal(r;\ell)
=
\frac{\Ucal(r;\ell)}{\left[\max\!\left(\widehat C(r;\ell),C_{\rm floor}\right)\right]^{\alpha}}
-\lambda_\kappa\left(1-\Ncal_2^{\qse}(r;\ell)\right),
