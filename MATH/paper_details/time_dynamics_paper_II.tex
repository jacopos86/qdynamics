...
\end{center}
\captionof{figure}{Deviation of the doublon fraction from the exact trajectory, same runs as Fig.~\ref{fig:obs_doublon_strongfast}.  The raw observable cannot separate the policies because all of them track it; the deviation can.  The exchange route and the comparator run an order of magnitude below the append-only ablation for most of the horizon.  \tentative{One drive.}}
