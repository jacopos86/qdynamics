...
% BEGIN_MACHINE_READABLE_HH_S_ACCOUNTING_SHADOW_RUNTIME_20260709
% {
...
%     "appendix_spin_boson_rabi_weak": 627,
%     "appendix_spin_boson_rabi_strong": 3620,
%     "appendix_bose_hubbard_weak": 1785,
%     "appendix_bose_hubbard_strong": 1816,
%     "appendix_hubbard_weak": 4922,
%     "appendix_hubbard_strong": 737
%   },
...
% }
% END_MACHINE_READABLE_HH_S_ACCOUNTING_SHADOW_RUNTIME_20260709
%
...
\midrule
SNAKE & 13 & 4.524e-04 & 48 & 34 & 183 & 4,469 \\
...
Method & \(k_{\rm pl}\) & \(|\Delta E|\) & \(N_{\twq}\) & \(D_{\twq}\) & \(D_c\) & \(S\)\\
\midrule
SNAKE & 10 & 2.158e-04 & 38 & 30 & 133 & 3,740 \\
...
Method & \(k_{\rm pl}\) & \(|\Delta E|\) & \(N_{\twq}\) & \(D_{\twq}\) & \(D_c\) & \(S\)\\
\midrule
SNAKE & 11 & 1.591e-06 & 44 & 37 & 200 & 3,678 \\
...
Method & \(k_{\rm pl}\) & \(|\Delta E|\) & \(N_{\twq}\) & \(D_{\twq}\) & \(D_c\) & \(S\)\\
\midrule
SNAKE & 16 & 1.841e-02 & 70 & 61 & 206 & 16,627 \\
...
Method & \(k_{\rm pl}\) & \(|\Delta E|\) & \(N_{\twq}\) & \(D_{\twq}\) & \(D_c\) & \(S\)\\
\midrule
SNAKE & 28 & 6.871e-04 & 150 & 121 & 540 & 27,387 \\
...
Method & \(k_{\rm pl}\) & \(|\Delta E|\) & \(N_{\twq}\) & \(D_{\twq}\) & \(D_c\) & \(S\)\\
\midrule
SNAKE & 13 & 4.683e-05 & 48 & 39 & 188 & 4,613 \\
...
$k_{\rm pl}$ & $|\Delta E|$ & $N_{\twq}$ & $D_{\twq}$ & $D_c$ & $S$ \\
\midrule
3 & \(10{\times}10^{-6}\) & 115 & 111 & 723 & 3{,}620 \\
\bottomrule
\end{tabular}
}
\end{center}
...
$k_{\rm pl}$ & $|\Delta E|$ & $N_{\twq}$ & $D_{\twq}$ & $D_c$ & $S$ \\
\midrule
1 & \(8{\times}10^{-16}\) & 160 & 160 & 870 & 1{,}785 \\
\bottomrule
\end{tabular}
}
\end{center}
...
$k_{\rm pl}$ & $|\Delta E|$ & $N_{\twq}$ & $D_{\twq}$ & $D_c$ & $S$ \\
\midrule
1 & \(1{\times}10^{-15}\) & 160 & 160 & 870 & 1{,}816 \\
\bottomrule
\end{tabular}
}
\end{center}
...
$k_{\rm pl}$ & $|\Delta E|$ & $N_{\twq}$ & $D_{\twq}$ & $D_c$ & $S$ \\
\midrule
8 & \(2{\times}10^{-11}\) & 18 & 10 & 120 & 4{,}922 \\
\bottomrule
\end{tabular}
}
\end{center}
