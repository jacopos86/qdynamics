...
from pipelines.scaffold.hh_continuation_types import SymmetrySpec
...
def build_symmetry_spec(
    *,
    ...
    if family_key in _LOW_RISK_FAMILIES:
        leakage_risk = 0.0
    elif family_key in {"residual", "full_meta", "pareto_lean", "pareto_lean_l3", "pareto_lean_l2", "full_hamiltonian"}:
        leakage_risk = 0.1
    else:
        leakage_risk = 0.2
