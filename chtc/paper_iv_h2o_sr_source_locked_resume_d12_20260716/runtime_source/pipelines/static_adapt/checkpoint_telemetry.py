    ...
    *,
    ...
    return {
        ...
        "configured_bounds": {
            ...
            "phase_live_hysteresis_enabled": bool(cfg.phase_live_hysteresis_enabled),
            "phase2_null_nrem_high_threshold": float(cfg.phase2_null_nrem_high_threshold),
            "phase2_live_nrem_low_threshold": float(cfg.phase2_live_nrem_low_threshold),
            "phase3_null_nrem_high_threshold": float(cfg.phase3_null_nrem_high_threshold),
            "phase3_live_nrem_low_threshold": float(cfg.phase3_live_nrem_low_threshold),
            "phase2_hysteresis_steps": int(cfg.phase2_hysteresis_steps),
            "phase3_hysteresis_steps": int(cfg.phase3_hysteresis_steps),
        },
