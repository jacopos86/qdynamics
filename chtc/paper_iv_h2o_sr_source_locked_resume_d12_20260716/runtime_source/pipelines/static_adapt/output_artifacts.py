    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "settings": {
            ...
            "phase1_prune_policy": str(getattr(args, "phase1_prune_policy", "legacy_small_angle_v1")),
            ...
            "phase1_prune_tolerance_mode": str(getattr(args, "phase1_prune_tolerance_mode", "auto")),
            "phase1_prune_tolerance_shot_coeff": float(getattr(args, "phase1_prune_tolerance_shot_coeff", 0.0)),
            "phase1_prune_tolerance_screen_coeff": float(getattr(args, "phase1_prune_tolerance_screen_coeff", 0.01)),
            "phase1_prune_tolerance_chem": float(getattr(args, "phase1_prune_tolerance_chem", 0.0)),
            "phase1_prune_tolerance_rel_coeff": float(getattr(args, "phase1_prune_tolerance_rel_coeff", 0.0)),
            "phase1_prune_tolerance_target_energy": (
                None
                if getattr(args, "phase1_prune_tolerance_target_energy", None) is None
                else float(getattr(args, "phase1_prune_tolerance_target_energy"))
            ),
            ...
            "phase1_prune_prefilter_policy": str(getattr(args, "phase1_prune_prefilter_policy", "off")),
            "phase1_prune_prefilter_json": (
                None
                if getattr(args, "phase1_prune_prefilter_json", None) is None
                else str(Path(getattr(args, "phase1_prune_prefilter_json")))
            ),
            "phase1_prune_risk_threshold": float(getattr(args, "phase1_prune_risk_threshold", 0.0)),
            "phase1_prune_prefilter_max_candidates": int(
                getattr(args, "phase1_prune_prefilter_max_candidates", 1)
            ),
            ...
            "phase2_gamma_N_schedule_mode": str(getattr(args, "phase2_gamma_N_schedule_mode", "fixed")),
            "phase2_gamma_N_schedule_start": (
                None
                if getattr(args, "phase2_gamma_N_schedule_start", None) is None
                else float(getattr(args, "phase2_gamma_N_schedule_start"))
            ),
            "phase2_gamma_N_schedule_end": (
                None
                if getattr(args, "phase2_gamma_N_schedule_end", None) is None
                else float(getattr(args, "phase2_gamma_N_schedule_end"))
            ),
            ...
            "phase2_novelty_mode": str(getattr(args, "phase2_novelty_mode", "collective_span_v1")),
            "phase3_novelty_ablation_mode": str(
                getattr(args, "phase3_novelty_ablation_mode", "off")
            ),
            ...
            "phase2_batch_target_size": _optional_int(args.phase2_batch_target_size),
            "phase2_batch_size_cap": _optional_int(args.phase2_batch_size_cap),
            "phase2_batch_near_degenerate_ratio": _optional_float(args.phase2_batch_near_degenerate_ratio),
            "phase2_batch_rank_rel_tol": _optional_float(args.phase2_batch_rank_rel_tol),
            "phase2_batch_additivity_tol": _optional_float(args.phase2_batch_additivity_tol),
            ...
            "phase2_gram_novelty_policy": str(
                getattr(args, "phase2_gram_novelty_policy", "ordinary_multiplier_v1")
            ),
            "phase3_gram_novelty_policy": str(
                getattr(args, "phase3_gram_novelty_policy", "ordinary_multiplier_v1")
            ),
