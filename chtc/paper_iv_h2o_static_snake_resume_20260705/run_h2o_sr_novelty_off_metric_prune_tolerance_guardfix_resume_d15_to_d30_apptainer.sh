...
TASK_SCRIPT="chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_tolerance_guardfix_resume_d15_to_d30_task.sh"
EXPECTED_CODE_ARCHIVE_SHA256="4d63b7ede5ec87aab9fb3f8e6ccc654e66c9295139add4385068a5cb128fce65"
...
"$APPTAINER_BIN" exec --cleanenv --bind "$ROOT:/work" "$IMAGE" \
  bash -lc 'cd /work && bash chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_tolerance_guardfix_resume_d15_to_d30_task.sh "$@"' -- "$@"
