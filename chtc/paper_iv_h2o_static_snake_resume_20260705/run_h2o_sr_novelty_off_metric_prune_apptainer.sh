...
TASK_SCRIPT="chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_task.sh"
EXPECTED_CODE_ARCHIVE_SHA256="cb0e074d442980f32a71661489a725fac6b7c3bdb234abfb69f7a0ae71999567"
...
"$APPTAINER_BIN" exec --cleanenv --bind "$ROOT:/work" "$IMAGE" \
  bash -lc 'cd /work && bash chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_task.sh "$@"' -- "$@"
