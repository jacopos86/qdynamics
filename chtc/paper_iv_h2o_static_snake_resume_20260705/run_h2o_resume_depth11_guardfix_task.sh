...
RECORD_ID="${1:-paper_iv_h2o_resume_depth11_r15_whitened_adaptive_trust_nobatch_metric_prune_guardfix_powell}"
ROOT="$PWD"
...
FIXTURE_JSON="${H2O_FIXTURE_JSON:-tmp/h2o_linear_fd_valence_psi4_optimized/h2o_linear_fd_sparse_fixture_nph1_ref2.json}"
RESUME_SCAFFOLD_JSON="${H2O_RESUME_SCAFFOLD_JSON:-raw_outputs/paper_iv_h2o_resume_depth8_r15_whitened_adaptive_trust_nobatch_metric_prune_powell/current.json}"
CODE_ARCHIVE="${H2O_CODE_ARCHIVE:-chtc/paper_iv_h2o_static_snake_resume_20260705/input/h2o_whitened_nobatch_metric_prune_guardfix_code_20260713.tgz}"
EXPECTED_FIXTURE_SHA256="0f44965d180d52edd57992a16329a444379ce35a906216d75c4c161a63ed393a"
EXPECTED_RESUME_SHA256="c35b0c3ee6d17f6df855d0167201a2f65a3c56031d22a008e54f0efa3336f7f6"
RESUME_DEPTH="${H2O_RESUME_DEPTH:-11}"
ADAPT_MAX_DEPTH="${H2O_ADAPT_MAX_DEPTH:-15}"
ADAPT_SEGMENT_ID="${H2O_ADAPT_SEGMENT_ID:-paper_iv_h2o_depth11_r15_whitened_adaptive_trust_nobatch_metric_prune_guardfix_powell}"
    ...
    + json.dumps(
        {
            ...
            "resume_depth": int(observed_depth),
            **observed_fixture,
        },
        sort_keys=True,
    ),
...
payload = {
    "schema": "paper_iv_h2o_static_snake_chtc_submit_manifest_v2",
