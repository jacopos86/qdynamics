...
TASK_SCRIPT="chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_resume_depth11_guardfix_task.sh"
EXPECTED_CODE_ARCHIVE_SHA256="b89c0a0138a402ddd9721818679e30561d947388d7a81e4d72c3ad1bc58c3869"
...
"$APPTAINER_BIN" exec --cleanenv --bind "$ROOT:/work" "$IMAGE" \
  bash -lc 'cd /work && bash chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_resume_depth11_guardfix_task.sh "$@"' -- "$@"
