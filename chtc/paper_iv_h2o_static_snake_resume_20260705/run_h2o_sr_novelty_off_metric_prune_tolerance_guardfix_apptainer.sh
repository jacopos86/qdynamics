...
TASK_SCRIPT="chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_tolerance_guardfix_task.sh"
...
"$APPTAINER_BIN" exec --cleanenv --bind "$ROOT:/work" "$IMAGE" \
  bash -lc 'cd /work && bash chtc/paper_iv_h2o_static_snake_resume_20260705/run_h2o_sr_novelty_off_metric_prune_tolerance_guardfix_task.sh "$@"' -- "$@"
