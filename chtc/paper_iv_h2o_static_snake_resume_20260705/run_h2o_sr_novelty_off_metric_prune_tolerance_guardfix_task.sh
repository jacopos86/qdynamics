...
RECORD_ID="${1:-paper_iv_h2o_sr_snake_novelty_off_metric_prune_tolerance_guardfix_powell_d15}"
ROOT="$PWD"
...
ADAPT_SEGMENT_ID="${H2O_ADAPT_SEGMENT_ID:-paper_iv_h2o_sr_snake_novelty_off_metric_prune_tolerance_guardfix_powell_d15}"
...
payload = {
    ...
    "run_class": "candidate_diagnostic_fresh_sr_snake_tolerance_guardfix",
