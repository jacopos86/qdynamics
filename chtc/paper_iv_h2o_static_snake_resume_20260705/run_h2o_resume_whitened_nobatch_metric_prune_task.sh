...
RECORD_ID="${1:-paper_iv_h2o_resume_depth8_r15_whitened_adaptive_trust_nobatch_metric_prune_powell}"
ROOT="$PWD"
...
RESUME_SCAFFOLD_JSON="${H2O_RESUME_SCAFFOLD_JSON:-tmp/h2o_linear_fd_valence_psi4_optimized/adapt_paper_i_current_powell_anchor_d15/h2o_depth6_checkpoint_for_chtc_20260705T001649Z.json}"
...
EXPECTED_RESUME_SHA256="32a7e2d9b3ccee2ab48d1f45e448fa0b71be2ab1eceb17e1881e16c6e96dc108"
RESUME_DEPTH="${H2O_RESUME_DEPTH:-8}"
ADAPT_MAX_DEPTH="${H2O_ADAPT_MAX_DEPTH:-15}"
ADAPT_SEGMENT_ID="${H2O_ADAPT_SEGMENT_ID:-paper_iv_h2o_depth8_r15_whitened_adaptive_trust_nobatch_metric_prune_powell}"
