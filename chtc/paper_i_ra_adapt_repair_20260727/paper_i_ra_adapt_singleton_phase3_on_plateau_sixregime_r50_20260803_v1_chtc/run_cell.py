    ...
    *, job_path: Path, authorization_path: Path, output_dir: Path, receipt_path: Path
    ...
    try:
        ...
        if set(preliminary) != {
            ...
            raise PackageContractError(
                "Successful execution payload closure is incomplete."
            )
        execution_manifest = digested(
            {
                "schema": "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_execution_manifest_v1",
                "status": "passed",
        ...
        receipt = digested(
            {
                "schema": "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_worker_receipt_v1",
                "status": "passed",
                "package_id": PACKAGE_ID,
                "campaign_id": CAMPAIGN_ID,
                "execution_id": job["execution_id"],
