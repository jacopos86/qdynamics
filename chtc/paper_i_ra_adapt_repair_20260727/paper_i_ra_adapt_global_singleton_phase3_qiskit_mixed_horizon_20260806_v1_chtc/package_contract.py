#!/usr/bin/env python3
"""Closed local-package contract for the Phase-III-only Qiskit campaign."""
...
CAMPAIGN_ID = (
    "paper_i_ra_adapt_global_singleton_phase3_qiskit_mixed_horizon_v1"
)
BUNDLE_ID = "ra_adapt_global_singleton_phase3_qiskit_mixed_horizon_v1"
RUN_CLASS = "candidate"
...
TARGET_ROUTE_SUFFIX = "qiskit_full_ansatz_transpile_cost_phase3_only_v1"
TARGET_ROUTE_PROFILE = f"{SOURCE_ROUTE_PROFILE}__{TARGET_ROUTE_SUFFIX}"
...
def execution_id(regime_id: str, nph: int) -> str:
    return f"phase3_qiskit_candidate__{regime_id}__nph{int(nph)}__{ROUTE_ID}"
