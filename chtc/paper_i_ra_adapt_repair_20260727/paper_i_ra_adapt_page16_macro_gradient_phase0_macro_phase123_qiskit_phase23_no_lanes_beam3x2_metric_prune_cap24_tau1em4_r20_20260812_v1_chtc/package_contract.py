#!/usr/bin/env python3
"""Closed contract for the Page-16 macro Qiskit beam/prune study."""
...
CAMPAIGN_ID = (
    "paper_i_ra_adapt_page16_macro_gradient_phase0_macro_phase123_qiskit_"
    "phase23_no_lanes_beam3x2_metric_prune_cap24_tau1em4_r20_v1"
)
BUNDLE_ID = (
    "ra_adapt_page16_macro_gradient_phase0_macro_phase123_qiskit_phase23_"
    "no_lanes_beam3x2_metric_prune_cap24_tau1em4_r20_v1"
)
RUN_CLASS = "candidate"
...
ROUTE_ID = (
    ...
    "no_lanes_plateau_beam3x2_metric_prune"
)
...
EXECUTION_ID_PREFIX = (
    "page16_macro_gradient_phase0_phase23_qiskit_no_lanes_beam3x2_metric"
)
STAGE_ID = "page16_macro_phase23_qiskit_beam3x2_metric_prune_candidate"

HORIZON = 20
REGIME_ROWS: tuple[tuple[str, int, int], ...] = (
    ("weak_weak", 3, HORIZON),
    ("intermediate_weak", 3, HORIZON),
    ("strong_weak_u8", 3, HORIZON),
    ("weak_strong", 7, HORIZON),
    ("intermediate_strong", 7, HORIZON),
    ("strong_strong_u8", 7, HORIZON),
)
...
BASELINE_PACKAGE_MANIFEST_FILE_SHA256 = (
    "c9c880e078ef78c93cd3676e17528042c7c329afa44a38aaeec5b0d292957f1d"
)
...
RESOURCE_ENVELOPES = {
    3: {
        ...
        "basis": (
            "page16_nph3_qiskit_plus_corrected_page13_beam_metric_"
            "observed_envelope_with_branch_headroom_v1"
        ),
    },
    7: {
        "request_cpus": 4,
        ...
        "max_runtime_seconds": 259_200,
        "basis": (
            "page16_nph7_qiskit_plus_corrected_page13_beam_metric_"
            "observed_envelope_with_branch_headroom_v1"
        ),
    },
}
...
PACKAGE_MANIFEST_SCHEMA = (
    "paper_i_ra_adapt_page16_macro_phase23_qiskit_beam_metric_package_"
    "manifest_v1"
)
JOB_SCHEMA = (
