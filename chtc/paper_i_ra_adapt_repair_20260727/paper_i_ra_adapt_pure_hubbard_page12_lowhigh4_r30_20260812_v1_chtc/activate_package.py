...
def _render_submit_template(
    *,
    ...
    replacements = {
        ...
        "__PACKAGE_MANIFEST_FILE_SHA256__": package_manifest_file_sha256,
        "__JOB_WRAPPER_SHA256__": job_wrapper_sha256,
        "__RUN_CELL_SHA256__": run_cell_sha256,
        "__PACKAGE_CONTRACT_SHA256__": package_contract_sha256,
    }
...
def activate(
    *,
    ...
    if (
        ...
        or package_manifest.get("status") != INERT_PACKAGE_STATUS
    ...
    control_files = validate_control_file_bindings(
    ...
    if (
        ...
        or probe_receipt.get("deep_worker_preflight_count") != CELL_COUNT
        or probe_receipt.get("deep_worker_preflight_runtime")
        != "pinned_execution_image"
        or probe_receipt.get("deep_pinned_numerical_p4_passed") is not True
    ...
    try:
        ...
        rendered = _render_submit_template(
            ...
            job_wrapper_sha256=str(
                control_files["execute_authorized_job.sh"]["sha256"]
            ),
            run_cell_sha256=str(control_files["run_cell.py"]["sha256"]),
            package_contract_sha256=str(
                control_files["package_contract.py"]["sha256"]
            ),
        )
