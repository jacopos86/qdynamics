#!/usr/bin/env python3
"""Closed contract for the six-regime endpoint-overlap trust ablation."""
...
PACKAGE_ID = (
    ...
    "tau1em6_overlap_trust_r50_20260807_v1_chtc"
)
CAMPAIGN_ID = (
    "paper_i_ra_adapt_global_singleton_phase3_qiskit_denominator_no_lanes_"
    "tau1em6_overlap_trust_r50_v1"
)
BUNDLE_ID = (
...
ROUTE_ID = "ra_global_singleton_plateau_commutation_overlap_trust"
...
TARGET_ROUTE_PROFILE = (
    ...
    "identity_phase_ii__stationary_source_response_v1__"
    "all_phase_resource_weighting_v1__"
    "endpoint_overlap_displacement_trust_v1__"
    f"{TARGET_ROUTE_SUFFIX}"
)
TRUST_POLICY_ID = "supported_predicted_fs_endpoint_overlap_trust_v1"
TRUST_UPDATE_POLICY = "displacement_calibrated_unbounded_v2"
