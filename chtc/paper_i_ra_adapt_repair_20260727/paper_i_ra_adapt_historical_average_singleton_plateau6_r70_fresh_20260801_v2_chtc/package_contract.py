...
PACKAGE_ID = (
    ...
    "r70_fresh_20260801_v2_chtc"
)
CAMPAIGN_ID = (
    "paper_i_ra_adapt_historical_average_singleton_plateau6_r70_fresh_v2"
)
...
def execution_id(regime_id: str, nph: int) -> str:
    return (
        f"historical_average_v2_r70_fresh__{regime_id}__nph{int(nph)}__"
        "ra_singleton_plateau"
    )
