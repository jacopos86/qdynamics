#!/usr/bin/env python3
"""Fail-closed validation for the inert six-cell cumulative-relative package."""
...
def validate_package(
    *, deep: bool = False, smoke_one_round: bool = False
    ...
    if (
        ...
        or plan.get("success_rows_leave_queue") is not True
    ...
    return digested(
        {
            "schema": "paper_i_ra_adapt_cumulative_relative_singleton_plateau6_r70_package_validation_v1",
            "status": "passed",
