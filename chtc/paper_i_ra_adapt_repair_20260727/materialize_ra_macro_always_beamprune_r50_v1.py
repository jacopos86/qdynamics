...
from pipelines.static_adapt.ra_adapt.bundles import (  # noqa: E402
    BEAMPRUNE_BUNDLE_ID,
    build_beamprune_cell_specs,
    materialize_beamprune_bundle,
)
...
MATERIALIZATION_ID = "ra_adapt_macro_always_beamprune_r50_v1"
...
def main(*, materialization_id: str = MATERIALIZATION_ID) -> int:
    ...
    receipt = materialize_beamprune_bundle(
        destination,
