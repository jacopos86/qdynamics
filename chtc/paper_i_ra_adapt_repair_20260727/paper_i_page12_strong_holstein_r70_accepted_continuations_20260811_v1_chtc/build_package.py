...
+JobBatchName = "paper-i-page12-strong-r70-cont-v1"
...
def build() -> dict[str, Any]:
    ...
    plan = digested(
        {
            "schema": "paper_i_page12_strong_r70_chtc_plan_v1",
            "status": "passed_inert",
            "package_id": PACKAGE_ID,
            "campaign_id": CAMPAIGN_ID,
            "row_count": 3,
    ...
    request = digested(
        {
            "schema": "paper_i_page12_strong_r70_chtc_activation_request_v1",
            "package_id": PACKAGE_ID,
            "campaign_id": CAMPAIGN_ID,
