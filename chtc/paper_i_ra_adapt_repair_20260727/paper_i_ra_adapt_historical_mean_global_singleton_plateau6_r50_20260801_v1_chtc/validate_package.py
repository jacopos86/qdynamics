#!/usr/bin/env python3
"""Validate the inert historical-mean global-singleton six-cell package."""
...
def validate_package(
    *, deep: bool = False, smoke_one_round: bool = False
    ...
    return digested(
        {
            "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau6_r50_package_validation_v1",
            "status": "passed",
