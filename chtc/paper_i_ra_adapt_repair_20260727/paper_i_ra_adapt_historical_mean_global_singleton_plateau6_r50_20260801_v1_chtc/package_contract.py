#!/usr/bin/env python3
"""Closed contract for the six-cell historical-mean global-singleton run."""
...
CAMPAIGN_ID = (
    "paper_i_ra_adapt_historical_mean_global_singleton_plateau6_r50_v1"
)
...
JOB_SCHEMA = (
    "paper_i_ra_adapt_historical_mean_global_singleton_plateau6_r50_job_v1"
)
...
def execution_id(regime_id: str, nph: int) -> str:
    return (
        f"historical_mean_global_singleton_v1_r50__{regime_id}__"
