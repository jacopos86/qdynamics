#!/usr/bin/env python3
"""Seal the inert, preauthorization 12-cell RA-always CHTC package.
...
def _source_members(
    *,
    ...
    for source_kind, rows in (
        ...
        (
            "append_runtime_hash_dependency",
            APPEND_RUNTIME_SOURCE_DEPENDENCIES,
        ),
    ):
        for raw in rows:
    ...
    return digested(
        {
            ...
            "direct_cell_count": DIRECT_EXECUTION_COUNT,
...
def build_package(
    *,
    ...
    plan_unsigned = {
        ...
        "execution_ids": list(direct_execution_ids()),
        "g11_bounded_replay_diagnostic_count": sum(
            bool(row["g11_bounded_replay_diagnostic"]["selected"])
