...
```bash
python -B chtc/paper_i_ra_adapt_repair_20260727/paper_i_ra_adapt_page9_strong3_r50_to_r70_20260809_v1_chtc/validate_package.py --worker-preflight
```
...
```bash
page9_package=chtc/paper_i_ra_adapt_repair_20260727/paper_i_ra_adapt_page9_strong3_r50_to_r70_20260809_v1_chtc
resume_root=/staging/jsstrobel/paper_i_ra_adapt_page9_strong3_r70_20260809_v1/resume_inputs
