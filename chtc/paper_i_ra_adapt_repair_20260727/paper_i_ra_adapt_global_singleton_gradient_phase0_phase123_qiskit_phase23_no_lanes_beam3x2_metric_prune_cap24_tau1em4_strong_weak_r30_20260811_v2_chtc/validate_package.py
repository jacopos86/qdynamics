...
def validate_package(
    *,
    ...
    if (
        ...
        or manifest.get("weak_holstein_horizon") != WEAK_HORIZON
        or manifest.get("strong_holstein_horizon") != WEAK_HORIZON
    ...
    if len(jobs) != len(expected_ids) or len(protocols) != len(expected_ids):
    ...
    if deep:
        ...
        launch_ready = deep_count == len(expected_ids)
