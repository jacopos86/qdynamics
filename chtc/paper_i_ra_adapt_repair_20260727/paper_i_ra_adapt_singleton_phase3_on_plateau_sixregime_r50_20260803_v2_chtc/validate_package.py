#!/usr/bin/env python3
"""Fail-closed validation for the inert Phase-III-on-plateau package."""
...
def validate_package(
    *, deep: bool = False, smoke_one_round: bool = False
    ...
    if (
        ...
        or plan.get("execution_mode") != "fresh_0_to_50"
    ...
    if (
        ...
        raise PackageContractError("Exact v1-to-v2 source patch audit drifted.")
    ...
    return digested(
        {
            "schema": "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_package_validation_v1",
            "status": "passed",
