#!/usr/bin/env python3
"""Fail-closed contract for the one-row weak-strong canary Phase-III activation."""
...
ACTIVATION_ID = f"{PACKAGE_ID}_activation_canary_weak_strong_v1"
ACTIVATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_"
    "canary_weak_strong_activation_v1"
)
AUTHORIZATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_"
    "execution_authorization_v1"
)
BATCH_NAME = "paper-i-ra-phase3-on-plateau-r50-v2-canary-weak-strong-v1"
...
def authorization_payload(
    *,
    ...
    return {
        ...
        "authorization_source": "explicit_user_request_2026-08-03",
