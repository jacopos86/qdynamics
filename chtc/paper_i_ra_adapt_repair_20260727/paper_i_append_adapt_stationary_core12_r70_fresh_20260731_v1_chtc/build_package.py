#!/usr/bin/env python3
"""Build the inert, source-locked 12-row fresh round-70 CHTC package."""
...
def _validate_source_package() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(
        prefix="paper_i_append_r70_source_package_validation_"
    ) as raw:
...
def _preliminary_job(
    *,
    ...
    return {
        ...
        "resources": dict(source_job["resources"]),
...
def build_package() -> dict[str, Any]:
    ...
    anchor_evidence = materialize_anchor_evidence()
    atomic_write_json(
    ...
    with tempfile.TemporaryDirectory(
        prefix="paper_i_append_r70_source_"
    ) as raw:
    ...
    audit = digested(
        {
            ...
            "source": {
                ...
                "method": "Append-ADAPT",
                "regime_or_case": "six_regime_macro_and_singleton_matrix",
                "source_package_id": SOURCE_PACKAGE_ID,
                "source_package_manifest_sha256": (
                    SOURCE_PACKAGE_MANIFEST_SHA256
                ),
                ...
                "route_or_profile_id": (
                    "conventional_append_macro_and_single_pauli_word_v1"
                ),
