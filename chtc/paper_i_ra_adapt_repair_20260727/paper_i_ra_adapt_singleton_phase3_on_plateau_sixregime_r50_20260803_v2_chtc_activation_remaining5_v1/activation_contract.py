#!/usr/bin/env python3
"""Fail-closed contract for the remaining-five Phase-III activation."""
...
ACTIVATION_ID = f"{PACKAGE_ID}_activation_remaining5_v1"
ACTIVATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_"
    "remaining5_activation_v1"
)
AUTHORIZATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_"
    "execution_authorization_v1"
)
BATCH_NAME = "paper-i-ra-phase3-on-plateau-r50-v2-remaining5-v1"
...
DIRECT_EXECUTION_COUNT = 5
ROW_SELECTION = "remaining_five_excluding_weak_strong_canary_v1"
...
RUNTIME_RELATIVE = (
    ...
    f"{PACKAGE_ID}_runtime_remaining5_v1"
)
QUEUE_VARIABLES = (
    "execution_id",
    "job_path",
