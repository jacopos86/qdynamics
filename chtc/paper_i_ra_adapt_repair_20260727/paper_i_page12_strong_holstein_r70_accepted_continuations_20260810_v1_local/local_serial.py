...
DEFAULT_RUNTIME_DIR = REPO_ROOT / (
    ...
    "r50_to_r70_serial_20260810_v1"
)
SERIAL_STATUS_SCHEMA = "paper_i_page12_strong_r70_local_serial_status_v1"
SERIAL_MANIFEST_SCHEMA = "paper_i_page12_strong_r70_local_serial_manifest_v1"
MAX_CONCURRENCY = 1
...
def validate_page13_completion_gate() -> dict[str, Any]:
    ...
    return digested(
        {
            "schema": "paper_i_page13_completion_gate_receipt_v1",
...
def capacity_receipt(runtime_parent: Path) -> dict[str, Any]:
    ...
    return digested(
        {
            "schema": "paper_i_page12_strong_r70_local_capacity_receipt_v1",
...
def _validate_completed_cell(
    ...
    *,
    ...
    return digested(
        {
            "schema": "paper_i_page12_strong_r70_local_cell_closure_v1",
            "status": "passed",
...
def preflight(runtime_dir: Path) -> dict[str, Any]:
    ...
    return digested(
        {
            "schema": "paper_i_page12_strong_r70_local_serial_preflight_v1",
            "status": (
                "passed"
