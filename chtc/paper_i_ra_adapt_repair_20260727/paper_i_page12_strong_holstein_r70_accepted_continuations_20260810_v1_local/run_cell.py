...
def preflight(job_path: Path, *, verify_resume_bytes: bool) -> dict[str, Any]:
    ...
    return digested(
        {
            "schema": "paper_i_page12_strong_r70_worker_preflight_v1",
            "status": "passed",
    ...
    *,
    ...
    try:
        ...
        execution_manifest = digested(
            {
                "schema": "paper_i_page12_strong_r70_execution_manifest_v1",
                "status": "passed",
                "package_id": PACKAGE_ID,
        ...
        receipt = digested(
            {
                "schema": "paper_i_page12_strong_r70_worker_receipt_v1",
                "status": "passed",
                "package_id": PACKAGE_ID,
                "campaign_id": CAMPAIGN_ID,
                "execution_id": job["execution_id"],
