...
def _materialize_resume(spec: Mapping[str, Any]) -> dict[str, Any]:
    ...
    source_attempt = _build_resume_archive(spec, archive_path)
    members = [
        {
            "role": row["role"],
    ...
    provisional = digested(
        {
            "schema": "paper_i_page12_pointer_closed_resume_archive_v1",
            "status": "passed",
            "package_id": PACKAGE_ID,
            "regime_id": regime,
            "resume_round": SOURCE_HORIZON,
            "target_round": TARGET_HORIZON,
            "source_kind": "authenticated_page12_attempt_archive",
            "materialization_kind": "stream_selected_three_member_archive_v1",
            "member_count": 3,
            "members": members,
            "pointer_closed": True,
    ...
    receipt = digested(
        {
            "schema": "paper_i_page12_checkpoint_validation_receipt_v1",
            "status": "passed",
            "package_id": PACKAGE_ID,
            "regime_id": regime,
            "resume_round": SOURCE_HORIZON,
    ...
    manifest = digested(
        {
            **{key: value for key, value in provisional.items() if key != "sha256"},
...
def build() -> dict[str, Any]:
    ...
    composition = digested(
        {
            "schema": "paper_i_page12_r70_local_source_composition_v1",
            "status": "passed",
    ...
    plan = digested(
        {
            "schema": "paper_i_page12_strong_r70_local_plan_v1",
            "status": "passed_inert",
            "package_id": PACKAGE_ID,
            "campaign_id": CAMPAIGN_ID,
            "row_count": 3,
    ...
    request = digested(
        {
            "schema": "paper_i_page12_strong_r70_local_activation_request_v1",
            "package_id": PACKAGE_ID,
            "campaign_id": CAMPAIGN_ID,
