#!/usr/bin/env python3
"""Fail-closed contract for the weak-weak source-lock anchor activation."""
...
ACTIVATION_ID = (
    f"{PACKAGE_ID}_activation_source_lock_anchor_weak_weak_20260804_v1"
)
ACTIVATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_sixregime_r50_"
    "source_lock_anchor_weak_weak_activation_v1"
)
...
BATCH_NAME = (
    "paper-i-ra-phase3-on-plateau-r50-v3-"
    "source-lock-anchor-weak-weak-20260804-v1"
)
...
ROW_SELECTION = "weak_weak_source_lock_anchor_tau_1e_minus_4_only_v1"
ACTIVATION_EXECUTION_IDS = (
    "phase3_on_plateau_r50__weak_weak__nph3__ra_singleton_plateau",
)
RUNTIME_RELATIVE = (
    "chtc/paper_i_ra_adapt_repair_20260727/"
    f"{PACKAGE_ID}_runtime_source_lock_anchor_weak_weak_20260804_v1"
)
QUEUE_VARIABLES = (
    "execution_id",
    "job_path",
...
def validate_sealed_package(repo_root: Path) -> dict[str, Any]:
    ...
    for index, (execution_id, row) in enumerate(
        ...
        if (
            ...
            != contract.ROUTE_CONTRACT_SHA256
