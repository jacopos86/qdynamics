...
ACTIVATION_ID = (
    f"{PACKAGE_ID}_activation_confirmation_20260806_v1"
)
ACTIVATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_phase3_on_plateau_threshold_1em6_"
...
RUNTIME_RELATIVE = (
    ...
    f"{PACKAGE_ID}_runtime_confirmation_20260806_v1"
)
QUEUE_VARIABLES = (
    "execution_id",
    "job_path",
...
def _run_package_validator(package_dir: Path) -> dict[str, Any]:
    validator = package_dir.parent / "validate_threshold_sweep.py"
