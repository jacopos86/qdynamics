#!/usr/bin/env python3
"""Closed contract for the staged singleton Phase-II/III Qiskit run."""
...
PACKAGE_MANIFEST_SCHEMA = (
    "paper_i_ra_adapt_macro_then_singleton_phase23_qiskit_"
    "package_manifest_v1"
)
JOB_SCHEMA = (
    "paper_i_ra_adapt_macro_then_singleton_phase23_qiskit_job_v1"
)
...
SOURCE_LOCK_AUDIT_SCHEMA = (
    "paper_i_ra_adapt_macro_then_singleton_phase23_qiskit_source_lock_audit_v1"
)
SOURCE_ARCHIVE_MANIFEST_SCHEMA = (
    "paper_i_ra_adapt_macro_then_singleton_phase23_qiskit_source_archive_"
    "manifest_v1"
)
