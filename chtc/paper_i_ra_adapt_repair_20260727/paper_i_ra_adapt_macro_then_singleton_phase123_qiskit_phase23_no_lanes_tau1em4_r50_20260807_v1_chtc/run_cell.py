#!/usr/bin/env python3
"""Preflight or execute one staged singleton Phase-II/III Qiskit cell."""
...
def _load_closed_job(
    ...
    if (
        ...
        raise PackageContractError("Sealed staged-Qiskit job drifted.")
...
def _load_protocol(
    *,
    ...
    if (
        ...
        raise PackageContractError("Typed staged-Qiskit protocol drifted.")
