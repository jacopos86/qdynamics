#!/usr/bin/env python3
"""Closed contract for the macro-gradient Phase-0 Qiskit run."""
...
ROUTE_ID = (
    "ra_macro_gradient_phase0_then_singleton_phase123_qiskit_"
    "phase23_plateau"
)
...
TARGET_ROUTE_SUFFIX = (
    "macro_abs_gradient_phase0_then_guarded_singleton_phase1_then_qiskit_"
    "phase2_phase3_no_lanes_v1"
)
...
CANDIDATE_ADAPTER_ID = (
    "paper_i_ra_adapt_macro_gradient_phase0_then_singleton_candidate_"
    "adapter_v1"
)
...
EXPECTED_CANDIDATE_FUNNEL = (
    "macro_gradient_phase0_shortlist_then_guarded_singleton_phase1_"
    "shortlist_then_singleton_phase2_then_singleton_phase3_v1"
)
EXECUTION_ID_PREFIX = "macro_gradient_phase0_phase23_qiskit_no_lanes"
STAGE_ID = "macro_gradient_phase0_phase23_qiskit_no_lanes_candidate"
