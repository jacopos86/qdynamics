...
BATCH_NAME = (
    "paper-i-ra-global-singleton-plateau-nph7-r50-resume128gb-loaderfix-v2"
)
...
def _run_package_validator(repo_root: Path) -> dict[str, Any]:
    ...
    if (
        ...
        or receipt.get("implementation_repair") != IMPLEMENTATION_REPAIR
...
def validate_activation(repo_root: str | Path) -> dict[str, Any]:
    ...
    if (
        ...
        or package_manifest.get("implementation_repair")
        != IMPLEMENTATION_REPAIR
