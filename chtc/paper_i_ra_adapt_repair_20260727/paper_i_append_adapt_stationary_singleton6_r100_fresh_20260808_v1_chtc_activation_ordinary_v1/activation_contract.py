...
ACTIVATION_SCHEMA = (
    "paper_i_append_adapt_stationary_singleton6_r100_ordinary_activation_v1"
)
AUTHORIZATION_SCHEMA = (
    "paper_i_append_adapt_stationary_singleton6_r100_execution_authorization_v1"
)
BATCH_NAME = (
...
def validate_submit_text(text: str) -> None:
    required = (
        ...
        "hold = False",
        "output_destination = osdf:///chtc/staging/j/jsstrobel/"
        "paper_i_append_adapt_stationary_singleton6_r100_20260808_v1/"
        "outputs/",
...
def quota_release_contract() -> dict[str, Any]:
    return {
        ...
        "output_destination": "chtc_staging_osdf",
    }
