#!/usr/bin/env python3
"""Validate the inert Page-12 round-70 CHTC continuation package."""
...
def validate(*, full_resume: bool, worker_preflight: bool) -> dict[str, Any]:
    ...
    if (
        ...
        or manifest.get("source_continuation_package")
        != {
        ...
        or manifest.get("remote_output_root") != REMOTE_OUTPUT_ROOT
    ):
        raise PackageContractError("CHTC package identity/state drifted.")
    ...
    if (
        ...
        or activation.get("execution_target") != "chtc"
        or activation.get("authorization_count") != CONTINUATION_ROW_COUNT
        ...
        raise PackageContractError("CHTC activation state drifted.")
    for row in activation["authorizations"]:
        ...
        if (
            ...
            or authority.get("execution_target") != "chtc"
            ...
            raise PackageContractError("CHTC authorization drifted.")
    ...
    return digested(
        {
            "schema": "paper_i_page12_strong_r70_chtc_validation_v2",
            "status": "passed",
