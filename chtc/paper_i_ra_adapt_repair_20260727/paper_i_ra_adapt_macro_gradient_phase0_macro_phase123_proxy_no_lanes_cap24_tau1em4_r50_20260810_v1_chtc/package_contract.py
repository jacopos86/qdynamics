#!/usr/bin/env python3
"""Closed contract for the macro-only Phase-0 proxy/no-lanes run."""
...
ROUTE_ID = (
    "ra_macro_gradient_phase0_macro_phase123_proxy_no_lanes_plateau"
)
...
EXECUTION_ID_PREFIX = "macro_gradient_phase0_proxy_no_lanes"
STAGE_ID = "macro_gradient_phase0_proxy_no_lanes_candidate"
...
BASELINE_PACKAGE = Path(
    ...
    "paper_i_ra_adapt_macro_gradient_phase0_then_singleton_phase123_qiskit_"
    "phase23_no_lanes_cap24_tau1em4_r50_20260807_v1_chtc"
)
BASELINE_BUNDLE_ID = (
    "ra_adapt_macro_gradient_phase0_then_singleton_phase123_qiskit_phase23_"
    "no_lanes_cap24_tau1em4_r50_v1"
)
BASELINE_PACKAGE_MANIFEST_FILE_SHA256 = (
    "1da69d3b491d2c9e41a5d0412842048ee5ec86d0a8046c79b35fd40b4d615469"
)
BASELINE_PACKAGE_MANIFEST_CANONICAL_SHA256 = (
    "f58c8165960728afacdcf4e8f8f98d9a6403b748ccd03702c701c0f2838b0cd2"
)
...
RESOURCE_ENVELOPES = {
    3: {
        ...
        "basis": "macro_phase01_graph_span_no_lanes_nph3_r50_envelope_v1",
    },
    7: {
        "request_cpus": 4,
        ...
        "max_runtime_seconds": 259_200,
        "basis": "macro_phase01_graph_span_no_lanes_nph7_r50_envelope_v1",
    },
}
...
PACKAGE_MANIFEST_SCHEMA = (
    "paper_i_ra_adapt_macro_gradient_phase0_proxy_no_lanes_package_manifest_v1"
)
JOB_SCHEMA = (
    "paper_i_ra_adapt_macro_gradient_phase0_proxy_no_lanes_job_v1"
)
...
SOURCE_LOCK_AUDIT_SCHEMA = (
    "paper_i_ra_adapt_macro_gradient_phase0_proxy_no_lanes_source_lock_audit_v1"
)
