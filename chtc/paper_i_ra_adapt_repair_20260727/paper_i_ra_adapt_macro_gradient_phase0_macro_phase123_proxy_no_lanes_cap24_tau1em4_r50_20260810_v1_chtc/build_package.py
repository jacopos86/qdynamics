#!/usr/bin/env python3
"""Seal one six-regime macro-only Phase-0 proxy/no-lanes package."""
...
def _source_locks(cells: tuple[BundleCellSpec, ...]) -> dict[str, Any]:
    ...
    payload["derivation_overlay"] = {
        "schema": "macro_gradient_phase0_proxy_no_lanes_source_overlay_v1",
...
def build() -> dict[str, Any]:
    ...
    expected = digested(
        {
            "schema": "macro_gradient_phase0_proxy_no_lanes_expected_artifacts_v1",
            "bundle_id": BUNDLE_ID,
            "cells": {
                cell.cell_id: {
    ...
    bundle_manifest = digested(
        {
            "schema": "macro_gradient_phase0_proxy_no_lanes_bundle_manifest_v1",
            "bundle_id": BUNDLE_ID,
    ...
    validation = digested(
        {
            "schema": "macro_gradient_phase0_proxy_no_lanes_validation_v1",
            "status": "passed",
            "bundle_id": BUNDLE_ID,
            "protocol_count": 6,
    ...
    audit = digested(
        {
            "schema": "macro_gradient_phase0_proxy_no_lanes_source_audit_v1",
            "status": "passed",
