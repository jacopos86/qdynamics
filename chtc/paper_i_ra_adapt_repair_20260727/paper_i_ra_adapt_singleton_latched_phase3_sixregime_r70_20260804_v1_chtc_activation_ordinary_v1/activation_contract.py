#!/usr/bin/env python3
"""Fail-closed contract for the six-row latched-Phase-III activation."""
...
ACTIVATION_SCHEMA = (
    "paper_i_ra_adapt_singleton_latched_phase3_sixregime_r70_"
...
BATCH_NAME = "paper-i-ra-latched-phase3-sixregime-r70-20260804-v1"
IMAGE_PATH = "chtc/phase3_optuna/image.sif"
IMAGE_SHA256 = (
    "fa5c4ea89a19ad2fa4c264f3bce65d9e83b86b91618ed97dfc80ee7be401239f"
)
PACKAGE_EXECUTION_COUNT = 6
DIRECT_EXECUTION_COUNT = 6
ROW_SELECTION = "all_six_regime_rows_v1"
ACTIVATION_EXECUTION_IDS = (
    "latched_phase3_r70__weak_weak__nph3__ra_singleton_plateau",
    "latched_phase3_r70__intermediate_weak__nph3__ra_singleton_plateau",
    "latched_phase3_r70__strong_weak_u8__nph3__ra_singleton_plateau",
    "latched_phase3_r70__weak_strong__nph7__ra_singleton_plateau",
    "latched_phase3_r70__intermediate_strong__nph7__ra_singleton_plateau",
    "latched_phase3_r70__strong_strong_u8__nph7__ra_singleton_plateau",
)
...
RUNTIME_RELATIVE = (
    ...
    f"{PACKAGE_ID}_runtime_ordinary_v1"
)
QUEUE_VARIABLES = (
    "execution_id",
    "job_path",
...
def _load_package_contract(package_dir: Path) -> ModuleType:
    ...
    spec = importlib.util.spec_from_file_location(
        "latched_phase3_r70_sealed_package_contract", path
    )
...
def validate_sealed_package(repo_root: Path) -> dict[str, Any]:
    ...
    if (
        ...
        or contract.TARGET_HORIZON != TARGET_HORIZON
        or manifest.get("target_horizon") != TARGET_HORIZON
        or contract.ROUTE_CONTRACT_SHA256 != ROUTE_CONTRACT_SHA256
        ...
        or audit.get("cell_count") != PACKAGE_EXECUTION_COUNT
    ):
