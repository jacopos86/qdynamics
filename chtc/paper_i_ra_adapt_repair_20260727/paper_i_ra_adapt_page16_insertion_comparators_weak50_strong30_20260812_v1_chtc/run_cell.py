#!/usr/bin/env python3
"""Preflight or execute one Page-16 macro Phase-II/III Qiskit cell."""
...
def _load_closed_job(
    ...
    if (
        ...
        raise PackageContractError("Inert twelve-cell package manifest drifted.")
...
def _load_protocol(
    *,
    ...
    if (
        ...
        raise PackageContractError("Typed Page-16 macro Qiskit protocol drifted.")
