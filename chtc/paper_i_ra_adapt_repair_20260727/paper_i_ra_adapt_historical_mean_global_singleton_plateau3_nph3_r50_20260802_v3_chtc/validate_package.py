#!/usr/bin/env python3
"""Validate the repaired three-cell nph3 global-singleton package."""
...
def validate_package(
    *, deep: bool = False, smoke_one_round: bool = False
    ...
    return digested(
        {
            "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_package_validation_v2",
            "status": "passed",
