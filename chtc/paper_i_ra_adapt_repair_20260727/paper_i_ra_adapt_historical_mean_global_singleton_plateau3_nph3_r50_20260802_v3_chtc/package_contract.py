#!/usr/bin/env python3
"""Closed contract for the three nph3 historical-mean global-singleton repairs."""
...
JOB_SCHEMA = "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_job_v2"
...
def execution_id(regime_id: str, nph: int) -> str:
    return (
        f"historical_mean_global_singleton_v3_nph3_r50__{regime_id}__"
