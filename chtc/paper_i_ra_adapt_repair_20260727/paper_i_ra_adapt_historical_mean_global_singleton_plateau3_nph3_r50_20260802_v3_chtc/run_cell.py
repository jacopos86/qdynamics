...
def preflight(job_path: Path) -> dict[str, Any]:
    ...
    return digested(
        {
            "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_worker_preflight_v2",
            "status": "passed",
...
def smoke_one_round(job_path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        return digested(
            {
                "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_worker_smoke_v2",
    ...
    *, job_path: Path, authorization_path: Path, output_dir: Path, receipt_path: Path
    ...
    try:
        ...
        execution_manifest = digested(
            {
                "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_execution_manifest_v2",
                "status": "passed",
        ...
        receipt = digested(
            {
                "schema": "paper_i_ra_adapt_historical_mean_global_singleton_plateau3_nph3_r50_worker_receipt_v2",
                "status": "passed",
                "package_id": PACKAGE_ID,
                "campaign_id": CAMPAIGN_ID,
                "execution_id": job["execution_id"],
