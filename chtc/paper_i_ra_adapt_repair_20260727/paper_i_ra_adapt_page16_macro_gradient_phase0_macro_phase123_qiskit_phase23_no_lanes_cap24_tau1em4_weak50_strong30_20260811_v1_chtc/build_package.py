#!/usr/bin/env python3
"""Seal the six-regime Page-16 macro Phase-II/III Qiskit package."""
...
def _source_locks(cells: tuple[BundleCellSpec, ...]) -> dict[str, Any]:
    ...
    payload["derivation_overlay"] = {
        "schema": "page16_macro_phase23_qiskit_source_overlay_v1",
        ...
        "selector_compile_cost_policy": SELECTOR_COMPILE_COST_POLICY,
        "selector_compile_cost_phase_reuse": (
            SELECTOR_COMPILE_COST_PHASE_REUSE
        ),
...
def build() -> dict[str, Any]:
    ...
    if (
        ...
        or verify_self_digest(
            baseline_manifest,
            label="Page-13 proxy baseline package manifest",
        )
        != BASELINE_PACKAGE_MANIFEST_CANONICAL_SHA256
    ):
    ...
    expected = digested(
        {
            "schema": "page16_macro_phase23_qiskit_expected_artifacts_v1",
            "bundle_id": BUNDLE_ID,
            "cells": {
                cell.cell_id: {
    ...
    bundle_manifest = digested(
        {
            "schema": "page16_macro_phase23_qiskit_bundle_manifest_v1",
            "bundle_id": BUNDLE_ID,
    ...
    validation = digested(
        {
            "schema": "page16_macro_phase23_qiskit_validation_v1",
            "status": "passed",
            "bundle_id": BUNDLE_ID,
            "protocol_count": 6,
            "route_contract_sha256": next(iter(route_digests)),
            "qiskit_selector_cost_phases": ["phase_ii", "phase_iii"],
            "phase_i_compile_cost_source": "structural_proxy_v1",
            "selector_compile_cost_scope": BACKEND_COMPILE_SCOPE,
            "selector_compile_cost_policy": SELECTOR_COMPILE_COST_POLICY,
            "selector_compile_cost_phase_reuse": (
    ...
    audit = digested(
        {
            "schema": "page16_macro_phase23_qiskit_source_audit_v1",
            "status": "passed",
            "source_route_profile": SOURCE_ROUTE_PROFILE,
            "source_route_contract_sha256": SOURCE_ROUTE_CONTRACT_SHA256,
            "page13_source_route_profile": BASELINE_ROUTE_PROFILE,
            "page13_source_route_contract_sha256": (
                BASELINE_ROUTE_CONTRACT_SHA256
            ),
            ...
            "physical_operator_lanes_active": False,
            "structural_proxy_mode": STRUCTURAL_PROXY_MODE,
            "approved_settings_changes_from_page13_v3": {
                "selector_cost_route": {
                    "from": {
                        "phase_i": "marrakesh_graph_span_structural_proxy_v1",
                        "phase_ii": "marrakesh_graph_span_structural_proxy_v1",
                        "phase_iii": "marrakesh_graph_span_structural_proxy_v1",
                        "normalization": "family_robust_symmetric_arctan_v1",
                    },
                    "to": {
                        "scope": BACKEND_COMPILE_SCOPE,
                        "policy": SELECTOR_COMPILE_COST_POLICY,
                        "phase_reuse": SELECTOR_COMPILE_COST_PHASE_REUSE,
                        "phase_i": "structural_proxy_v1",
                        "phase_ii": "backend_transpile_v1",
                        "phase_iii": "backend_transpile_v1",
                        "normalization": "zero_centered_signed_arctan_v1",
                    },
                },
                "strong_holstein_horizon": {"from": 50, "to": 30},
            },
            "non_requested_scientific_settings_diff": [],
            "implementation_source_inventory_sha256": locks[
                "implementation_sources"
            ]["sha256"],
            "scientific_result_anchor_claimed": False,
