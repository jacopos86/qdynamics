...
def _load_closed_job(
    ...
    if (
        ...
        or manifest.get("status") != "passed_inert_one_cell"
        ...
        raise PackageContractError("Inert one-cell package manifest drifted.")
...
def _validate_authorization(
    ...
    *,
    ...
    if (
        ...
        != "prepare_one_cell_chtc_execution_and_submission_v1"
