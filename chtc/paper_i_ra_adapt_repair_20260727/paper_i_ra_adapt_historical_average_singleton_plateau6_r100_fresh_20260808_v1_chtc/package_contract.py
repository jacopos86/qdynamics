#!/usr/bin/env python3
"""Closed contract for the six-cell historical-average RA r100 package."""
...
CAMPAIGN_ID = (
    "paper_i_ra_adapt_historical_average_singleton_plateau6_r100_fresh_v1"
)
...
JOB_SCHEMA = (
    "paper_i_ra_adapt_historical_average_singleton_plateau6_r100_job_v1"
)
...
def execution_id(regime_id: str, nph: int) -> str:
    return (
        f"historical_average_v1_r100_fresh__{regime_id}__nph{int(nph)}__"
        "ra_singleton_plateau"
    )
