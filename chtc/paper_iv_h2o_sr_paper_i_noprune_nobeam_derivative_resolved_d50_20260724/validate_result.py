...
def validate_result_payload(
    *, command: dict[str, Any], result: dict[str, Any]
    ...
    expected = {
        ...
        "settings.phase3_enable_batching": False,
        ...
        "settings.adapt_pool": "full_meta_derivative_resolved_v2",
        "settings.adapt_benchmark_target_abs_delta_e": 0.0016,
        f"{contract_settings}.problem": "molecular_vibronic_h2o_linear_fd",
        f"{contract_settings}.adapt_pool": "full_meta_derivative_resolved_v2",
        f"{contract_settings}.adapt_max_depth": 50,
        f"{contract_settings}.phase0_pilot_enabled": False,
        f"{contract_settings}.phase3_novelty_ablation_mode": "off",
        f"{contract_settings}.phase2_gram_novelty_policy": "fallback_only_v1",
        f"{contract_settings}.phase3_gram_novelty_policy": "fallback_only_v1",
        ...
        f"{contract_settings}.adapt_beam_live_branches": 1,
        f"{contract_settings}.adapt_beam_children_per_parent": 1,
        f"{contract_settings}.adapt_beam_terminated_keep": 0,
        f"{contract_settings}.adapt_beam_terminal_archive_mode": "disabled",
        f"{contract_settings}.phase1_prune_enabled": False,
