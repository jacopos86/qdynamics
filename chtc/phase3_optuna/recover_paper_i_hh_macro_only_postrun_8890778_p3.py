#!/usr/bin/env python3
"""Recover reporting artifacts for macro-only CHTC row 8890778.3.
...
ORIGINAL_ARCHIVE_SHA256 = {
    3: "be5aa72c0371b2d3a3bc694b1527917be0cc0ef0800f1cb898c3b1785decdecb",
}
ORIGINAL_EXECUTION_SHA256 = {
    3: "b22fe93967bc924a59f1b40944253fdf5e7f4a09a4901798151c637de1c0ae9d",
}
ORIGINAL_JOB_MANIFEST_SHA256 = {
    3: "5bf9964db66e67c0622a9ffd26b934ec2d9e834a31371481d2764c9ceb808e61",
}
...
def recover_row(proc_id: int, recovery_root: Path) -> dict[str, Any]:
    ...
    validator = (
        REPO
        / "chtc/phase3_optuna/"
        "validate_paper_i_hh_macro_only_postrun_8890778_p3.py"
    )
    completed = subprocess.run(
        [
            sys.executable,
