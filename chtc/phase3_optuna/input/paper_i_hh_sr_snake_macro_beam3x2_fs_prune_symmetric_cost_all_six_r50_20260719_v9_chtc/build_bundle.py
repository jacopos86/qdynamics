...
BUNDLE_ID = 'paper_i_hh_sr_snake_macro_beam3x2_fs_prune_symmetric_cost_all_six_r50_20260719_v9_chtc'
...
def verify_prune_consumer_repair():
    import ast, tarfile
    predecessor = BUNDLE_DIR.parent / 'paper_i_hh_sr_snake_macro_beam3x2_fs_prune_symmetric_cost_all_six_r50_20260719_v3_chtc' / 'source_locked.tar.gz'
...
if __name__ == '__main__':
    verify()
    print('macro beam-prune v6 cost bundle verification passed')
