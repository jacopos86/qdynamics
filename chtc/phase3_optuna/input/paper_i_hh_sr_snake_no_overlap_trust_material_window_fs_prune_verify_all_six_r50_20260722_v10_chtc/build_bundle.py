...
def verify():
 ...
 assert r["bundle_id"]=='paper_i_hh_sr_snake_no_overlap_trust_material_window_fs_prune_verify_all_six_r50_20260722_v10_chtc'
 assert r["batch_name"]=='paper-i-hh-sr-material-window-fsprune-verify-six-r50-20260722-v10'
