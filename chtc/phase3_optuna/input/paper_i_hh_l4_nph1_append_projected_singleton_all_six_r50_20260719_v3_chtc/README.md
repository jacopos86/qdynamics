...
This v3 bundle is the operational successor to cluster `8889835`. Its inherited
wrapper repair successfully reached the generic ADAPT entry point, which then
stopped before iteration zero because the generic statevector safety gate still
had its default 10-qubit cap while this canonical register has 12 qubits. V3
records and exports a cap of exactly 12. The immutable scientific source
archive, Hamiltonians, projected-child pool, optimizer, seed, and Condor
