...
def _write_submit(
    ...
    *,
    ...
    lines = [
        "universe = vanilla",
        "batch_name = paper-i-hh-l4-nph1-append-projected-singleton-r50-20260719-v3",
    ...
    bundle_manifest = {
        ...
        "operational_successor": {
            "predecessor_bundle_id": (
                "paper_i_hh_l4_nph1_append_projected_singleton_all_six_"
                "r50_20260719_v2_chtc"
            ),
            "predecessor_cluster_id": 8889835,
            "predecessor_failure_stage": "pre-iteration resource guard",
            "repair_scope": "raise the explicit statevector qubit gate from 10 to 12",
