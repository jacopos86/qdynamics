...
SOURCE='d97bd6e33bc2c6b224e831e88095b17aaf5ac6a88d37e44c6264f2d48d789a11'
...
def verify():
    ...
    for path in jobs:
        ...
        assert job["bundle_id"]=='paper_i_hh_sr_snake_appendix_phase3_batch3_full_response_symmetric_cost_noprune_nobeam_no_ordinary_novelty_all_six_r50_20260720_v14_chtc'
