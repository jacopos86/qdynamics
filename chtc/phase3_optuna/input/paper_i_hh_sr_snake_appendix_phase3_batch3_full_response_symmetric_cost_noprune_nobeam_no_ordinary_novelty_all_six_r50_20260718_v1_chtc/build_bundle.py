...
hash-locked Phase-III batching overlay, resolves the explicit appendix
batch-three profile from that isolated archive, verifies all six same-cutoff
physics anchors, and writes six fresh round-0 to round-50 rows plus a
fail-closed submission preflight.  The main/no-batch archive is never modified.
"""
...
BUNDLE_ID = (
    ...
    "noprune_nobeam_no_ordinary_novelty_all_six_r50_20260718_v1_chtc"
)
BATCH_NAME = (
    "paper-i-hh-sr-appendix-phase3-batch3-fullresp-symcost-noprune-"
    "nobeam-nonovelty-six-r50-20260718-v1"
)
...
BATCH_OVERLAY_SHA256 = (
    "bd2cb19813f65458912cf23524f46794fc2c7cb0fe63718f47d255fb8e68cfa9"
)
BATCH_OVERLAY_FILE_HASHES = {
    "pipelines/static_adapt/adapt_pipeline.py": (
        "a698a85429ebec82ab349dbf68e44c5827aa76124833e611923deeb3519d31cf"
    ),
    ...
    "test/test_static_adapt_sr_phase3_batch_appendix_profile.py": (
        "ec8e5c467c2798e340f7fcbefbe9de2f376093d0296a060e8bb1bc4f8e012a33"
    ),
}
SOURCE_LOCK_STATE = "frozen_main_archive_plus_exact_phase3_batch_overlay_v1"
...
def verify_source_lock() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    revision = {
        ...
        "executable_source_authority": (
            "frozen_main_archive_plus_exact_phase3_batch_overlay_inventory_v1"
        ),
...
def job_command(row: dict[str, Any]) -> tuple[list[str], dict[str, str]]:
    ...
    argv = [
        ...
        "--adapt-segment-id", (
            f"{slug}-sr-appendix-phase3-batch3-r0-r{target_round}-20260718-v1"
        ),
...
def main() -> int:
    ...
    bundle_manifest = {
        ...
        "created_utc": utc_now(),
        "run_class": "appendix_phase3_batching_ablation_matrix",
        "parent_stage": "frozen_main_route_exact_one_factor_phase3_batch_variant_v1",
        "submission_scope": {
