...
BUNDLE_ID = (
    "paper_i_hh_append_comparators_macro_projected_singleton_all_six_"
    "r50_20260718_v2_chtc"
)
...
def _write_submit(
    ...
    *,
    ...
    lines = [
        "universe = vanilla",
        "batch_name = paper-i-hh-append-macro-singleton-r50-20260718-v2",
