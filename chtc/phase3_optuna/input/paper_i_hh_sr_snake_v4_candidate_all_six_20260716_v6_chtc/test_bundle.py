...
class ScaffoldTests(unittest.TestCase):
    def test_scaffold_is_fail_closed_and_names_corrected_contract(self) -> None:
        ...
        if not BUILT_BUNDLE:
            self.assertIn('EXPECTED_HEAD = "92cf00bb1e7c5c58cc2328c29cdcae9d772adfc0"', builder)
            self.assertIn('EXPECTED_TREE = "5608d20f6b77d200fa90cfdc0ec5e86feb89a71c"', builder)
