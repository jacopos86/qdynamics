...
def verify():
 ...
 if inventory.is_file():
  ...
  actual={p.relative_to(B).as_posix() for p in B.rglob("*") if p.is_file() and p.name!="submission_artifact_hashes.json" and p.suffix!=".pyc" and "__pycache__" not in p.parts}
