...
BATCH_NAME = "paper-i-hh-sr-no-overlap-trust-six-r50-20260720-v2"
ANCHOR = ROOT / (
...
def build() -> dict[str, Any]:
    ...
    for slug in REGIMES:
        ...
        argv[segment_index] = (
            f"{slug}-sr-no-overlap-trust-r0-r50-20260720-v2"
        )
        job["route_identity"] = {
...
'''
    ...
    (BUNDLE / "test_no_overlap_evidence_validation.py").write_text(
        '''import copy
