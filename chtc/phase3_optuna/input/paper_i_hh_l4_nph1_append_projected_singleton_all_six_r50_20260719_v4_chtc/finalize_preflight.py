#!/usr/bin/env python3
"""Record the HH L=4,nph=1 Append screen archive-only preflight."""
...
def main() -> int:
    ...
    payload = {
        "schema": "paper_i_hh_l4_nph1_append_preflight_v1",
        ...
        "checks": {
            "bundle_contract_tests": "15 passed",
            "archive_only_powell_cap_and_projected_pool_regressions": "8 passed",
            "archive_only_l4_one_round_smoke": (
                "pass; one completed Append round with both 12-qubit gates, exact fidelity, "
                "Qiskit compilation, and sector/padding checks"
            ),
            ...
            "normalized_manifest_count": 6,
            "append_v4_source_contract_lock_count": 6,
        ...
        "archive_only_smoke_receipt": _load(BUNDLE / "archive_one_round_smoke_receipt.json"),
    }
