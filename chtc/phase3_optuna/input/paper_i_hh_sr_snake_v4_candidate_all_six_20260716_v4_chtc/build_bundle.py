...
BUNDLE_ID = "paper_i_hh_sr_snake_v4_candidate_all_six_20260716_v4_chtc"
BATCH_NAME = "paper-i-hh-sr-v4-candidate-six-r30-20260716-v4"
...
EXPECTED_HEAD = "6e907b82cb1c375d537ab99d964b73bb18027a03"
EXPECTED_TREE = "e02a397e951bab024ee23cc8de8496f996e8ac16"
PROFILE_REQUEST = "sr_snake_v4"
PROFILE_RESOLVED = (
    "supported_whitened_adaptive_trust_full_response_symmetric_cost_fs_prune_v4"
)
PROFILE_CONTRACT_SHA256 = (
    "835841f4a2d9b348ce9af6df7364d85a5e4b0696b84696252e73cc8d2f3eb02d"
)
...
SOURCE_LOCK_STATE = "frozen_main_agent_confirmed_commit_preflight_not_submitted"
...
SMOKE8_ROOT = Path(
    "raw_outputs/paper_i_hh_sr_snake_v4_phase12_no_lambda_f_archive_smoke_20260716/"
    "weak_weak_8_admissions_cache_off_exact_f_v4"
)
...
def normalize_bundle_strings(value: Any) -> Any:
    ...
    if isinstance(value, str):
        return (
            ...
            .replace("20260716-v3", "<REVISION>")
            .replace("20260716-v4", "<REVISION>")
        )
    return value
...
def verify_source_lock() -> tuple[dict[str, Any], dict[str, Any]]:
    if len(EXPECTED_HEAD) != 40 or len(EXPECTED_TREE) != 40:
        raise ValueError(
            "v4 bundle source authority is not frozen: replace EXPECTED_HEAD and "
...
def job_command(row: dict[str, Any]) -> tuple[list[str], dict[str, str]]:
    ...
    argv = [
        ...
        "--adapt-segment-id", f"{slug}-sr-v4-r0-r30-20260716-v4",
...
def build_job(
    ...
    return _materialize_job_payload(
        row=row,
        contract=contract,
        archive=archive,
        argv=argv,
...
# Generated from the frozen v4-bundle source lock.  Matchmaking remains disabled until
