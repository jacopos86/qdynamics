...
PROFILE_DIGEST = "835841f4a2d9b348ce9af6df7364d85a5e4b0696b84696252e73cc8d2f3eb02d"
...
class ScaffoldTests(unittest.TestCase):
    def test_scaffold_is_fail_closed_and_names_corrected_contract(self) -> None:
        ...
        if not BUILT_BUNDLE:
            self.assertIn('EXPECTED_HEAD = "6e907b82cb1c375d537ab99d964b73bb18027a03"', builder)
            self.assertIn('EXPECTED_TREE = "e02a397e951bab024ee23cc8de8496f996e8ac16"', builder)
...
@unittest.skipUnless(BUILT_BUNDLE, "v4 bundle source authority has not been frozen")
