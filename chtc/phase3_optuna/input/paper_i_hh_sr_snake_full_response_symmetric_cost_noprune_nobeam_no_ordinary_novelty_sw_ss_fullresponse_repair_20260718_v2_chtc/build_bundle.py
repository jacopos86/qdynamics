#!/usr/bin/env python3
"""Build the source-locked two-row SR-SNAKE full-response repair bundle.
...
verifies all six same-cutoff physics anchors, and writes two fresh round-0
submission rows plus a fail-closed submission preflight.
"""
...
BATCH_NAME = (
    ...
    "nonovelty-sw-ss-fullresponse-repair-20260718-v2"
)
...
SUBMISSION_REGIMES = frozenset({
    "strong_weak_u8", "strong_strong_u8",
})
...
CRITICAL_SOURCE_SHA256 = {
    "pipelines/static_adapt/adapt_pipeline.py": "88b7de1e762db9f5d87a37228b9b166faf9a82d373d9f62edcc07bc194ce63a2",
    ...
    "test/test_static_adapt_accepted_refit.py": "72f7bd0f0b336399a7a0b860546ee27e09c00bddd8f6a7a1d86ec6431cd7f76d",
...
def main() -> int:
    ...
    if (
        ...
        raise ValueError(
            "repair bundle must queue exactly strong-weak and strong-strong"
        )
    ...
    bundle_manifest = {
        ...
        "run_class": "candidate",
        "parent_stage": (
            "fresh_round0_full_response_runtime_repair_strong_weak_"
            "strong_strong_v1"
        ),
        "submission_scope": {
