...
class ScaffoldTests(unittest.TestCase):
    def test_scaffold_is_fail_closed_and_names_corrected_contract(self) -> None:
        ...
        if not BUILT_BUNDLE:
            self.assertIn('EXPECTED_HEAD = "8a746d244a15e2cb16099a732e78e1110a8e59f2"', builder)
            self.assertIn('EXPECTED_TREE = "6cb596ab953386a9c9a3b0698e7b1489e3b0f02e"', builder)
