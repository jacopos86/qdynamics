...
def validate_result_and_compile(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema": "paper_i_hh_sr_snake_v4_parent_validation_v1",
        "status": "pass",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    normalized = {
        "schema": "paper_i_hh_sr_snake_v4_runtime_manifest_v1",
    ...
    execution = {**normalized, "schema": "paper_i_hh_sr_snake_v4_execution_v1", "status": "running", "exit_code": None}
