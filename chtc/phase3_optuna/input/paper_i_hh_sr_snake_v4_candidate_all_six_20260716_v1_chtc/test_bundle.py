...
class BundleTests(unittest.TestCase):
    def test_six_exact_parent_jobs(self) -> None:
        for slug, (u, cutoff, exact) in EXPECTED.items():
            ...
            self.assertEqual(job["route_identity"]["profile_contract_sha256"], "447b8fe3f4fef340fbb1cd5d221a0234826ba80c7e4e405937004e4ab25bec93")
            ...
            completed = subprocess.run(
                [sys.executable, str(BUNDLE / "run_job.py"), "--validate-only", str(BUNDLE / "jobs" / f"{slug}.json")],
    ...
    def test_archive_only_preflight_and_relative_parity(self) -> None:
        ...
        self.assertEqual(
            isolated["focused_source_locked_regressions"]["expected_pass_count"], 44
        )
