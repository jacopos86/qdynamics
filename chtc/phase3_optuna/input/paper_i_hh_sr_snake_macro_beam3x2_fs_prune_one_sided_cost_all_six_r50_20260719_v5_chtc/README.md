# paper-i-hh-sr-macro-beam3x2-fsprune-onesided-six-r50-20260719-v5

> **SUPERSEDED — DO NOT SUBMIT.** Cluster `8894498` exposed a
...
- Supersedes non-scientific post-run fidelity-validation predecessor cluster
  `8893084` without changing scientific settings.

## v5 non-scientific repair

Derived directly from the immutable v3 source archive. Exact prune-trial consumer IDs include the parent beam branch; beam history serializes the existing physical-lane receipt; and validation separates the 50-round controller/frontier from the selected terminal winner. Route settings, selection, terminal archive policy, and digest are unchanged.
