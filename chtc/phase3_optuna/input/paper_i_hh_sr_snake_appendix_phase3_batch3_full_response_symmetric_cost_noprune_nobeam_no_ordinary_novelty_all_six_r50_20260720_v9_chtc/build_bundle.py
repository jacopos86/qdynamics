...
def verify():
    ...
    for path in jobs:
        ...
        assert job["bundle_id"]=='paper_i_hh_sr_snake_appendix_phase3_batch3_full_response_symmetric_cost_noprune_nobeam_no_ordinary_novelty_all_six_r50_20260720_v9_chtc'
        assert job["batch_name"]=='paper-i-hh-sr-appendix-phase3-batch3-fullresp-symcost-noprune-nobeam-nonovelty-six-r50-20260720-v9'
