...
BATCH_NAME = (
    ...
    "nobeam-nonovelty-six-r50-20260718-v2"
)
...
BATCH_OVERLAY_SHA256 = (
    "8be89354853f9df3bc810d38bd4a9982e7195d4de27b894b0b405403bb7f2113"
)
BATCH_OVERLAY_FILE_HASHES = {
    "pipelines/static_adapt/adapt_pipeline.py": (
        "bde3c85ef88154a238efde920710fb06fd9aa5b913939a1603fcc96784fec58b"
    ),
    ...
    "test/test_static_adapt_sr_phase3_batch_appendix_profile.py": (
        "52dafd835bf5d91a6ac3d11bce8434a501921d059317099f00f7ea7fb00e1853"
    ),
}
SOURCE_LOCK_STATE = (
...
def verify_source_lock() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    revision = {
        ...
        "executable_source_authority": (
            "frozen_main_archive_plus_exact_phase3_batch_overlay_"
            "plus_exact_route_alias_validation_repair_inventory_v2"
        ),
...
def job_command(row: dict[str, Any]) -> tuple[list[str], dict[str, str]]:
    ...
    argv = [
        ...
        "--adapt-segment-id", (
            f"{slug}-sr-appendix-phase3-batch3-r0-r{target_round}-20260718-v2"
        ),
