    ...
    *,
    ...
    for outer_iteration, (history_raw, checkpoint_raw) in enumerate(
        ...
        if (
            ...
            or trust.get("policy") != "source_metric_inverse_sqrt_no_overlap_v1"
...
def validate_no_overlap_trust_evidence(
    *, result: dict[str, Any], target_round: int,
    ...
    zero_active_coordinate_holds = 0
    contractions = 0
    expansions = 0
    holds = 0
    for expected_round, row in enumerate(history, start=1):
        ...
        zero_active_coordinate_hold = bool(
            expected_round == 1
            ...
            and float(receipt.get("update_factor")) == 1.0
            and float(receipt.get("radius_before"))
            == float(receipt.get("radius_after"))
        )
        if zero_active_coordinate_hold:
            zero_active_coordinate_holds += 1
        elif receipt.get("geometry_expansion_active") is True:
    ...
    return {
        ...
        "zero_active_coordinate_hold_count": zero_active_coordinate_holds,
