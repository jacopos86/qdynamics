# Beam-v4 held-row memory successor

This thin immutable overlay retries only parent cluster `8887576`
...
Memory requests use `ceil_1p10_observed_memory_usage_to_4096mb_tier_v1` and are recorded per row in
