...
OUTPUT_ROOT="raw_outputs/paper_i_hh_sr_snake_strong_strong_r45_20260714_v2_chtc/strong_strong"
TRANSFER_ARCHIVE="raw_outputs/paper_i_hh_sr_snake_strong_strong_r45_20260714_v2_chtc/strong_strong_transfer.tar.gz"
...
"$APPTAINER_BIN" exec --cleanenv --bind "$ROOT:/work" "$IMAGE" \
  ...
  -- \
  "chtc/phase3_optuna/input/paper_i_hh_sr_snake_strong_strong_r45_20260714_v2_chtc/run_job.py" \
  "$JOB_MANIFEST"
