...
BUNDLE_ID = "paper_i_hh_sr_snake_v4_candidate_all_six_20260716_v2_chtc"
BATCH_NAME = "paper-i-hh-sr-v4-candidate-six-r30-20260716-v2"
BUNDLE_DIR = Path(__file__).resolve().parent
REPO = BUNDLE_DIR.parents[3]
EXPECTED_HEAD = "c33039c66838bf6f058c2fa0c5bb58945feeaa9e"
EXPECTED_TREE = "084c6f38f9847383d30b15f267c9453f4f1b677d"
PROFILE_REQUEST = "sr_snake_v4"
PROFILE_RESOLVED = (
    "supported_whitened_adaptive_trust_full_response_symmetric_cost_fs_prune_v4"
)
PROFILE_CONTRACT_SHA256 = (
    "7f99682678c1c338ad73142e604c2cc6757dbb4db311a3b0bb8cb7b23e8436be"
)
...
SMOKE8_ROOT = Path(
    ...
    "diagnostic_admissions8_finite_angle_disabled_v3"
)
...
CRITICAL_SOURCE_HASHES = {
    ...
    "pipelines/static_adapt/sr_snake_route_profile.py": (
        "6c6b8de448beaafa44066e4585ecf6c948431015ef8c491cea183868361f6034"
    ),
...
def verify_source_lock() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    revision = {
        "schema": "paper_i_hh_sr_snake_v4_source_revision_v2",
        "git_commit": head,
        "git_tree": tree,
    ...
    physics_lock = {
        "schema": "paper_i_hh_sr_snake_v4_physics_exact_reference_lock_v2",
...
def build_source_archive() -> dict[str, Any]:
    ...
    return {
        "schema": "paper_i_hh_sr_snake_v4_source_archive_manifest_v2",
...
def archive_only_preflight(
    *, archive: dict[str, Any], job_paths: list[Path]
    ...
    with tempfile.TemporaryDirectory(prefix="sr_v4_archive_preflight_") as tmp:
        ...
        focused_45_pass = bool(
            focused_tests.returncode == 0
            and "45 passed" in focused_tests.stdout
        )
        all_parse = all(row["returncode"] == 0 for row in parse_rows)
        return {
            "schema": "paper_i_hh_sr_snake_v4_archive_only_preflight_v2",
            "status": (
                "pass" if import_pass and all_parse and helper_present
                and helper_help_returncode == 0 and focused_45_pass else "blocked"
            ),
...
def job_command(row: dict[str, Any]) -> tuple[list[str], dict[str, str]]:
    ...
    argv = [
        ...
        "--adapt-segment-id", f"{slug}-sr-v4-r0-r30-20260716-v2",
...
def build_job(
    ...
    return {
        "schema": "paper_i_hh_sr_snake_v4_candidate_parent_job_v2",
        "bundle_id": BUNDLE_ID,
...
def smoke_summary() -> dict[str, Any]:
    expected_hashes = {
        "json/result.json": (
            "a545c67e6ee36d5734c73cd12c50ca617c2a2cd5d7a3463cdf4c3f44add0322d"
        ),
        "json/current.json": (
            "9d96b12ec681cb07fe7cdc84d642a2841b85088b27412fdcdc3e9cc90d792cae"
        ),
        "json/estimator_call_ledger.json": (
            "9ba141d6d7aa8e44f6c1ab4ac7bade56bfa39545be15f73cd873cb699fbdfb32"
        ),
        "json/qiskit_cost_sidecar.json": (
            "569d565bef205cab7f693d7a05d7ee80563e73adcd9c96af7371917c6e46f287"
        ),
        "json/qiskit_compile_repaired_checkpoint.json": (
            "f9520d297132c2cbe9639a5715de64a443419d90897e4c848cf7cd9e1fe12310"
        ),
        "source_lock/anchor_command.json": (
            "37d0505eda35c86aa75c6c6740ed91055fa21d43168ad7c982a966c1f617e797"
        ),
        "source_lock/validation_summary.json": (
            "9feecc3704f8d27b4ed283765686c4b597cce1bbee16ed82db34d272ddb2c247"
        ),
    }
    ...
    required_smoke_gates = {
        ...
        "phase3_oracle_gradient_config_absent",
    ...
    return {
        "schema": "paper_i_hh_sr_snake_v4_local_smoke_evidence_v2",
        "status": "pass_for_bundle_construction_not_a_production_result",
        "records": [{
            "label": "eight_admission_finite_angle_disabled_v4",
...
def remote_preflight_and_cleanup_receipt() -> dict[str, Any]:
    ...
    return {
        "schema": "paper_i_hh_sr_snake_v4_remote_preflight_cleanup_receipt_v2",
        "status": "pass",
...
def main() -> int:
    ...
    for row in REGIMES:
        ...
        dump_json(normalized_path, {
            "schema": "paper_i_hh_sr_snake_v4_normalized_parent_manifest_v2",
            "bundle_id": BUNDLE_ID,
            "regime_slug": slug,
    ...
    continuation_template = {
        "schema": "paper_i_hh_sr_snake_v4_round30_to_round50_continuation_template_v2",
    ...
    parity = {
        "schema": "paper_i_hh_sr_snake_v4_route_parity_v2",
        "status": "pass",
        "profile_request": PROFILE_REQUEST,
        "profile_resolved": PROFILE_RESOLVED,
        "profile_contract_sha256": PROFILE_CONTRACT_SHA256,
    ...
    bundle_manifest = {
        "schema": "paper_i_hh_sr_snake_v4_candidate_bundle_v2",
        "bundle_id": BUNDLE_ID,
        "batch_name": BATCH_NAME,
        "created_utc": utc_now(),
        "run_class": "candidate",
    ...
    preflight = {
        "schema": "paper_i_hh_sr_snake_v4_candidate_preflight_v2",
        "created_utc": utc_now(),
        ...
        "checks": {
            ...
            "isolated_archive_focused_45_regressions": bool(
    ...
    dump_json(BUNDLE_DIR / "submission_artifact_hashes.json", {
        "schema": "paper_i_hh_sr_snake_v4_submission_artifact_hashes_v2",
        "artifacts": inventory,
    })
    print(json.dumps({
