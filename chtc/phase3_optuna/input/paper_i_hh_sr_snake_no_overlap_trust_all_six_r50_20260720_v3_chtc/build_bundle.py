...
SOURCE='589c85f3bd33ea1fbc7115d3eb8273bb88ccb6e36f57f763d025095dbb43ffc1'
...
def verify():
    ...
    for path in jobs:
        ...
        assert job["bundle_id"]=='paper_i_hh_sr_snake_no_overlap_trust_all_six_r50_20260720_v3_chtc'
