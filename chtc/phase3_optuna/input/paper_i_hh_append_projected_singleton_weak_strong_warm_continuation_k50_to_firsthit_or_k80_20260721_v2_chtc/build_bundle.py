...
This immutable successor enables Condor submission after the narrow stop-policy
extension passed review and the exact parent payload passed remote-image
preflight.  The exact uploaded v2 payload must still pass the same external
preflight before ``condor_submit`` is invoked.
"""
...
BUNDLE_ID = (
    ...
    "k50_to_firsthit_or_k80_20260721_v2_chtc"
)
BUNDLE_CREATED_UTC = "2026-07-21T21:45:03+00:00"
BATCH_NAME = "paper-i-hh-append-proj-singleton-ws-k50-firsthit2e4-k80-v2"
...
def _build_job(
    ...
    audit = {
        ...
        "submission_blocker": "exact uploaded v2 archive/image preflight required externally before condor_submit",
    }
...
requirements = True
# Submission enabled; exact uploaded-v2 archive/image preflight remains an external gate.
...
def main() -> int:
    ...
    bundle_manifest = {
        ...
        "bundle_id": BUNDLE_ID,
        "batch_name": BATCH_NAME,
        "status": "submission_enabled_remote_gate_pending",
        "row_count": 1,
        "job_id": JOB_ID,
        ...
        "remote_image_preflight": "exact_uploaded_v2_required_before_condor_submit",
    ...
    receipt = {
        ...
        "created_utc": _utc_now(),
        "status": "pass_local_submission_enabled_remote_gate_pending",
        "bundle_id": BUNDLE_ID,
        ...
        "max_total_iterations": MAX_TOTAL_ITERATIONS,
        "queue_rows": 1,
        "requirements_false": False,
        "remote_upload_performed": False,
        "remote_submission_performed": False,
        "unresolved_blocker": "exact uploaded v2 archive/image preflight required before condor_submit",
    }
