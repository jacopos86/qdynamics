...
BUNDLE_ID = (
    ...
    "symmetric_cost_noprune_no_ordinary_novelty_all_six_r50_20260718_v2_chtc"
)
BATCH_NAME = (
    "paper-i-hh-sr-appendix-historical-beam3x2-fullresp-symcost-"
    "noprune-nonovelty-six-r50-20260718-v2"
)
...
def job_command(row: dict[str, Any]) -> tuple[list[str], dict[str, str]]:
    ...
    argv = [
        ...
        "--adapt-segment-id", (
            f"{slug}-sr-appendix-historical-beam3x2-r0-r{target_round}-20260718-v2"
        ),
