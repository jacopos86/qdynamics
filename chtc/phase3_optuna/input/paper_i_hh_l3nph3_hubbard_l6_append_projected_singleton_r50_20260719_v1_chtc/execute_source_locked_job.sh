...
BUNDLE_ID="paper_i_hh_l3nph3_hubbard_l6_append_projected_singleton_r50_20260719_v1_chtc"
OUTPUT_ROOT="raw_outputs/${BUNDLE_ID}/${JOB_ID}"
TRANSFER_ARCHIVE="raw_outputs/${BUNDLE_ID}/${JOB_ID}_transfer.tar.gz"

# Canonical higher-L case tokens include uppercase `L`; keep the value path-safe
# while accepting both ASCII letter cases.
