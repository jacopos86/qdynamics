...
SOURCE='f1e0f6e245089ef37ca864d803d02b863fbc998bddbadcb6050d9d3b1d636bd2'
...
def verify():
    ...
    for path in jobs:
        ...
        assert job["bundle_id"]=='paper_i_hh_sr_snake_appendix_phase3_greedy_batch3_full_response_symmetric_cost_noprune_nobeam_no_ordinary_novelty_all_six_r50_20260720_v11_chtc'
