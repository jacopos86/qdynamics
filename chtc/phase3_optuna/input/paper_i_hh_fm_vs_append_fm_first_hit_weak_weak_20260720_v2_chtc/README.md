...
normalized scientific settings; this v2 bundle supersedes the failed v1 launch,
whose FM arm exited before round 1 because it combined that seed with an empty
formal-manifold scaffold.
