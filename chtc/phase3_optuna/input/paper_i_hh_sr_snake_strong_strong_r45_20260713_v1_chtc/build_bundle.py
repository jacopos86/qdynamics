...
BUNDLE_ID = "paper_i_hh_sr_snake_strong_strong_r45_20260713_v1_chtc"
...
def main() -> int:
    ...
    shutil.copy2(source_archive_path, LOCKED_ARCHIVE)
    if sha256(LOCKED_ARCHIVE) != SOURCE_ARCHIVE_SHA256:
        raise ValueError("copied source archive SHA-256 mismatch")
...
arguments = $(job_manifest) {archive_rel} {SOURCE_ARCHIVE_SHA256} {IMAGE.as_posix()} {IMAGE_SHA256}
...
+MaxRuntime = 259200
+JobBatchName = "paper-i-hh-sr-ss-r45-20260713-v1"
notification = Never
