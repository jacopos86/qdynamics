...
def _raw_ledger_prune_accounting_audit(
    *,
    ...
    if int(executed.get("optimizer_and_guard_nfev_reported", -1)) != (
        refit_occurrence_total
        + int(occurrence_components.get("N_H_outer", 0))
        - int(occurrence_scopes.get("outer_state_refresh", 0))
    ):
