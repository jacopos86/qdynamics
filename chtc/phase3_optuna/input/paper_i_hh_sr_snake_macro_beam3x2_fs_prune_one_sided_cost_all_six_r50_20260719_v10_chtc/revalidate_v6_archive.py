#!/usr/bin/env python3
"""Non-destructively revalidate one completed v6 failure with the v10 validator."""
...
V10_BUNDLE_ID = run_job.BUNDLE_ID
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="sr_macro_cost_v9_revalidate_") as tmp:
        ...
        receipt = {
            "schema": "paper_i_sr_macro_beam_cost_v10_v6_archive_revalidation_v1",
            "status": "pass",
            ...
            "v10_validator_bundle_id": V10_BUNDLE_ID,
