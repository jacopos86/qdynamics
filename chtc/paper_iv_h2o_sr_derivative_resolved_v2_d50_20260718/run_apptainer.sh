...
STAGE="chtc/paper_iv_h2o_sr_derivative_resolved_v2_d50_20260718"
INPUT="$STAGE/input"
IMAGE="${PROJECT_IMAGE:-chtc/phase3_optuna/image.sif}"
DELIVERABLE="deliverables/paper_iv_h2o_sr_derivative_resolved_v2_from_zero_d50_20260718_v1"
